...
float snoise(vec2 v){
  const vec4 C = vec4(0.211324865405187, 0.366025403784439, -0.577350269189626, 0.024390243904439);
...
export default function Aurora({ colorStops = ['#22d3ee', '#a78bfa', '#38bdf8'], amplitude = 1, blend = 0.5, speed = 1 }: AuroraProps) {
